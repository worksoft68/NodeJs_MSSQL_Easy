...
module.exports = {
	...
	indexString: async function(req, res, next) {
		...
		let languageString 	= JSON.stringify(languageInterface.text);//await publicFunction.getLanguage(collection+".ini");
...
save: async function (req, res, next) {
	let err = validate.validateReq(req,res, name_cookie_language);
