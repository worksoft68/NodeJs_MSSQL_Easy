...
const collection = "product_Groups";//use this parameter to check permissions: save, select, delete.... 
...
const pageTitleIndex = 'Product Groups Management';
...
module.exports = {
	...
	indexString: async function(req, res, next) {
		...
		//Get the language interface from cookies, This will save system resources
		//let name_Cookie_Language = 'language_'+collection.toLowerCase();  	
		
		let languageString 	= JSON.stringify(await publicFunction.getLanguageRequest(req, name_Cookie_Language));//await publicFunction.getLanguage(collection+".ini");
...
// end indexString =================================================================================================
	...
	indexJson: async function(req, res, next) {
		...
		// } 
		let language 	= await getLanguageRequest(req, res);//await publicFunction.getLanguage(collection+".ini");
...
save: async function (req, res, next) {
	let err = validateRequest.validateReq(req,res, name_Cookie_Language,validate.options);
