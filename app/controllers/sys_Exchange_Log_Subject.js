...
const collection = "sys_Exchange_Log_Subject";//use this parameter to check permissions: save, select, delete.... 
...
const pageTitleIndex = 'Exchange Log Subject Management';
